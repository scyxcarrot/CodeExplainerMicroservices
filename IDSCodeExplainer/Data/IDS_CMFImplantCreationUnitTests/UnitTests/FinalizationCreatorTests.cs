...
{
    [TestClass]
    public class FinalizationCreatorTests
    {
        [TestMethod]
        ...
        public void Creator_Throws_Exception_When_Incorrect_ComponentInfo_Given()
        {
            ...
            //Act
            var creator = new FinalizationCreator(console, mockComponentInfo.Object, new Configuration());
        ...
        public void Creator_Do_Not_Throw_Exception_When_Correct_ComponentInfo_Given()
        {
            ...
            //Act
            var creator = new FinalizationCreator(console, componentInfo, new Configuration());

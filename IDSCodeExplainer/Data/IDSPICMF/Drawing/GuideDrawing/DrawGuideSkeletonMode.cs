...
{
    public class DrawGuideSkeletonMode : IDrawGuideState
    {
        ...
        public DrawGuideSkeletonMode(ref DrawGuideDataContext dataContext)
        {
        ...
        public void OnKeyboard(int key, DrawGuide drawGuide)
        {
            ...
            {
                case (76): // L
                    OnFinalize(drawGuide.LowLoDConstraintMesh, out dummy);
                    break;
                case (80): // P
        ...
        {
            var action = new AddControlPointSkeletonGuideAction();

...
namespace IDS.PICMF.NonProduction
{
    ...
    [System.Runtime.InteropServices.Guid("34F01F68-0163-4482-A22C-8C52FB74F650")]
    [CommandStyle(Style.ScriptRunner)]
    [IDSCMFCommandAttributes(DesignPhase.Implant | DesignPhase.Guide, IBB.ImplantSupport)]
    public class CMF_TestCreateOldActualImplant : CmfCommandBase
    {
        static CMF_TestCreateOldActualImplant _instance;
        public CMF_TestCreateOldActualImplant()
        {
            _instance = this;
        }

        public static CMF_TestCreateOldActualImplant Instance => _instance;

        public override string EnglishName => "CMF_TestCreateOldActualImplant";

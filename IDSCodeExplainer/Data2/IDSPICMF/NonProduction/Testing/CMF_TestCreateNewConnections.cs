...
{
#if (STAGING)
    [System.Runtime.InteropServices.Guid("B0E4B8CC-EE48-4E95-93B3-1BA479C8BFFC")]
    [CommandStyle(Style.ScriptRunner)]
    [IDSCMFCommandAttributes(DesignPhase.Any, IBB.Screw)]
    public class CMF_TestCreateNewConnections : CmfCommandBase
    {
        public CMF_TestCreateNewConnections()
        {
            TheCommand = this;
        }

        public static CMF_TestCreateNewConnections TheCommand { get; private set; }

        public override string EnglishName => "CMF_TestCreateNewConnections";
        ...
        public override Result OnCommandExecute(RhinoDoc doc, RunMode mode, CMFImplantDirector director)
        {
            ...
            if (generatedPreviews.Any())
            {
                ...
                {
                    var layerIndex = doc.GetLayerWithPath($"New Connections {x.Key.CaseName}" + "::" + "Connections Preview");
                    ...
                    foreach (var result in x.Value.Item1)
                    {
                        var oa = new ObjectAttributes
                        {
                            ...
                            Name = $"New Connection Preview {x.Key.CaseGuid}"
                        };
